        ...
        <b-row>
          <b-col sm="4">
            <b-form-group label="Expiry" :label-cols="5" :horizontal="true">
              <b-form-input v-validate="'required'" name="expiry" id="expiry" v-model="user.expiry"></b-form-input>
  ...
  export default {
        ...
        this.$validator.validate().then(valid => {
          if (valid) {
            ...
            console.log(formData);
              userService.updateProduct(id, formData)
              .then(res => {
                console.log(res)
    ...
    created() {
      ...
      .then(res => {
        ...
        this.user.expiry = moment(res.data.expiry).format("DD/MM/YYYY")
